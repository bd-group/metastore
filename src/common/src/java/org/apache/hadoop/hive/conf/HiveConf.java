...
public class HiveConf extends Configuration {
  ...
  public static enum ConfVars {
    ...
    METASTORE_CLIENT_SOCKET_TIMEOUT("hive.metastore.client.socket.timeout", 30),
    ...
    METASTORE_CACHE_PINOBJTYPES("hive.metastore.cache.pinobjtypes", "Direct_ddl,Busi_column,Table,StorageDescriptor,SerDeInfo,Partition,Database,Files,Nodes,device,Type,FieldSchema,Order"),
    ...
    DM_CHECK_INVALIDATE_TIMEOUT("hive.diskmanager.check.invalidate.timeout", 120 * 1000),
    ...
    DM_INCREATEMENT_REP_TASK_TIMEOUT("hive.diskmanager.increate.reptask.timeout", 1 * 5 * 1000),
    DM_INCREATEMENT_REP_TIMEOUT("hive.diskmanager.increate.rep.timeout", 1 * 5 * 1000),
